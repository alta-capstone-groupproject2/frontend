            ...
            <div className="p-6 basis-5/6 flex">
              <div className="basis-2/3 flex flex-col gap-2">
                ...
                <p className="font-bold text-2xl flex justify-between items-center">
                  About this Event
                  <span className="text-red-600 text-sm rounded border-2 border-red-600 px-2">
                    Status : {event.status}
                  </span>
                </p>
                <p>{event.details}</p>
              ...
              <div className="basis-1/3 p-8">
                <img
                  src={
                    event.image === ""
                      ? "https://eproc.lkpp.go.id/v3/img/no-picture.jpg"
                      : event.image
                  }
                  alt=""
                ...
                <p className="text-2xl font-bold">
                  <span className="font-medium text-sm">
                    <div className="flex flex-col">
                      <b>From</b>
                      <span className="ml-2">
                        {moment(event.startDate, "DD-MM-YYYY").format("dddd")},{" "}
                        {moment
                          .utc(event.startDate)
                      ...
                      <b>To</b>
                      <span className="ml-2">
                        {moment(event.endDate, "DD-MM-YYYY").format("dddd")},{" "}
                        {moment
                          .utc(event.endDate)
                          .format("DD MMMM YYYY, HH:mm")}
                      </span>
