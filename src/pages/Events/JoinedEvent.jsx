                  ...
                  events.map((event) => (
                    ...
                    >
                      <img
                        ...
                        id={`img-goto-detail-${event.eventId}`}
                      />
                      <div
                        className="pl-8 py-4 break-all cursor-pointer flex-1"
                      ...
                      >
                        ...
                        <p className="">
                          ...
                          elit. Quas corporis, delectus id quaerat sapiente quam
                          unde, autem ex commodi magnam voluptas eos consectetur
                          alias recusandae. Facilis quas dolores odit laborum.
                        </p>
                      </div>
                      <div className="text-center px-14">
                        ...
                        >
                          <div className="absolute rounded top-1/3 left-[48%] bg-white border-2 p-4 flex flex-col items-center">
                            ...
                            <button className="text-sm bg-red-600 text-white px-4 rounded">
                              Print Qr Code
                            </button>
                          </div>
                        </Modal>
