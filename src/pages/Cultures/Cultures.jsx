				...
				<div className='p-12'>
					<div className='flex justify-between'>
						...
						<div className='flex'>
							...
							<input type='text' id='search-city-culture' placeholder='City..' onChange={(e) => setSearchParams({ city: e.target.value })} className='px-4 border focus:outline-none' />
							<label htmlFor='search-culture' className='flex items-center justify-center p-3 bg-red-700 text-white cursor-pointer'>
								<FaSearch />
							</label>
							<input type='submit' id='search-culture' className='hidden' onClick={() => searchCulture()} />
						</div>
					</div>
				</div>
				<div className='p-12'>
