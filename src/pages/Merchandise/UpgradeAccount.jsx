          ...
          <div className="w-full flex flex-col sm:flex-row mt-12 min-h-[80vh]">
            ...
            <div className="basis-5/6">
              ...
              <div className="pr-20">
                ...
                <div className="flex flex-row my-2 items-center">
                  <label className="basis-1/6">Store</label>
                  <div className="basis-5/6">
                    <input
                      id="input-name"
                      type={"text"}
                ...
                <div className="flex flex-row my-2 items-center">
                  <label className="basis-1/6">Owner</label>
                  <div className="basis-5/6">
                    <input
                      id="input-name"
                      type={"text"}
                ...
                <div className="flex flex-row my-2 items-center">
                  <label className="basis-1/6 self-start">Address</label>
                  <div className="basis-5/6">
                    <Autocomplete
                      value={address}
                      ...
                      onInputChange={(event, newInputValue) =>
                        handleChange(newInputValue, "inputAddress")
                      }
