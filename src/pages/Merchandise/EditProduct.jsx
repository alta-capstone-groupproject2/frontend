...
function EditProduct() {
  ...
  const apiGetProduct = async () => {
    setLoading(true);
    const token = localStorage.getItem("token");
    await apiRequest(`products/${params.id}`, "get", false, {
  ...
  const apiPutProduct = () => {
    ...
    apiRequest(`products/${params.id}`, "put", formData, {
        ...
        <Layout>
          <div className="w-full flex flex-col sm:flex-row mt-12 min-h-[80vh]">
            ...
            <div className="basis-5/6">
              <p className="font-bold text-lg">Edit Product</p>
              <div className="pr-20">
                <div className="flex flex-row my-2 items-center">
                  <label className="basis-1/6">Product Name</label>
                  <div className="basis-5/6">
                    <input
                      id="input-name"
                      type={"text"}
              ...
              <div className="pr-20">
                <div className="flex flex-row my-2 items-center">
                  <label className="basis-1/6">Image</label>
                  <div className="basis-5/6 ">
              ...
              <div className="pr-20">
                <div className="flex flex-row my-2 items-center">
                  <label className="basis-1/6">Stock</label>
                  <div className="basis-5/6">
                    <CurrencyFormat
                      id="input-stock"
                      value={stock}
                ...
                <div className="flex flex-row my-2 items-center">
                  ...
                  <div className="basis-5/6">
                    <textarea
                      ...
                      className="border-[0.1rem] rounded p-2 w-full h-56"
                      placeholder="Detail"
                    />
                  </div>
                </div>
