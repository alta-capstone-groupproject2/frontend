      ...
      <Layout>
        <div className="p-12 cursor-default">
          <div className="flex flex-wrap justify-between gap-4">
            <h1 className="font-bold border-b-2 border-red-700 pr-4 text-lg cursor-default">
              Merchandise
            </h1>
            <div className="flex flex-wrap">
              <input
                ...
                className="px-4 py-3 border focus:outline-none rounded-tl-md rounded-bl-md"
              />
              <input
                type="text"
                id="search-product-city"
                placeholder="City.."
              ...
              <label
                ...
                className="flex items-center justify-center p-3 bg-red-700 text-white cursor-pointer"
              >
                <FaSearch />
              </label>
              <input
        ...
        <div className="">
          {cart.map((item) => {
            return (
              <div
                className="grid grid-cols-1 gap-y-4 sm:gap-y-0 border sm:border-0 sm:grid-cols-12 hover:bg-slate-100 hover:rounded-md hover:shadow-sm p-6 cursor-default"
                key={item.cartID}
              >
                ...
                <div className="col-span-3 flex justify-center">
                  <div className="space-y-2">
                    <p id="product-name" className="text-lg font-bold">
                      {item.name}
                    </p>
                    <CurrencyFormat
                      value={item.price}
        ...
        <div className="p-12">
          <div className="flex flex-col items-end space-y-4">
            ...
            <button
              id="order-cart"
              onClick={() => showStepper()}
              className="py-1 px-5 rounded text-white bg-red-600 hover:bg-red-700 active:bg-red-800"
            >
              Payment
            </button>
            <Modal
            ...
            >
              <div className="absolute rounded p-6 pt-8 bg-white w-1/2 top-[10%] left-1/4 flex flex-col">
                <div className="flex justify-between mb-6 items-center">
                  ...
                  <button
                    className="text-2xl text-gray-300 hover:text-gray-400"
